...
//       inputs = List(Int),
//       output = Int,
//       invoke = repl.MdocSession$MdocApp$$Lambda/0x000000700264c600@16f87d49,
//       fresh = false
//     ),
//     Basic(
//       inputs = List(Int),
//       output = Int,
//       invoke = repl.MdocSession$MdocApp$$Lambda/0x000000700264c9d8@1cff31cd,
//       fresh = false
//     ),
//     Basic(
//       inputs = List(),
//       output = Int,
//       invoke = registry.Fun$package$$$Lambda/0x0000007002648c10@76aa8e02,
//       fresh = false
//     )
//   ),
//   refinements = List()
