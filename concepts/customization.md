...
//       inputs = List(Int),
//       output = Int,
//       invoke = repl.MdocSession$MdocApp$$Lambda/0x000000a802644600@24b79c75,
//       fresh = false
//     ),
//     Basic(
//       inputs = List(Int),
//       output = Int,
//       invoke = repl.MdocSession$MdocApp$$Lambda/0x000000a8026449d8@5192974a,
//       fresh = false
//     ),
//     Basic(
//       inputs = List(),
//       output = Int,
//       invoke = registry.Fun$package$$$Lambda/0x000000a802640c10@2216f05e,
//       fresh = false
//     )
//   ),
//   refinements = List()
